...
def dibujar_foster_derivacion(k0 = None, koo = None, ki = None, y_exc = None):
    ...
    if not(k0 is None and koo is None and ki is None):
        ...
        if not(k0 is None):
            ...
            d = dibujar_elemento_derivacion(d, Inductor, k0)
        ...
        if not(koo is None):
            ...
            d = dibujar_elemento_derivacion(d, Capacitor, 1/koo)
...
def dibujar_foster_serie(k0 = None, koo = None, ki = None, z_exc = None):
    ...
    if not(k0 is None and koo is None and ki is None):
        ...
        if not(k0 is None):
            ...
            d = dibujar_elemento_serie(d, Capacitor, k0)
            
        if not(koo is None):
        
            d = dibujar_elemento_serie(d, Inductor, 1/koo)
